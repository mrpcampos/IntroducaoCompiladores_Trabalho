...
public class PrintTree {
    ...
    public void printClassDeclNode(ClassDeclNode x) {
        ...
        System.out.println();
        System.out.print(x.number + ": ClassDeclNode ===> " + (x.accessModifier == null ? "null " : x.accessModifier.image) + " " + x.name.image +
    ...
    // ---------------- Lista de atribuição de variáveis ----------------
    ...
    public void printMethodDeclNode(MethodDeclNode x) {
        ...
        System.out.println();
        System.out.print(x.number + ": MethodDeclNode ===> " + (x.accessModifier == null ? "null " : x.accessModifier + " ") + (x.changeability == null ? "null " : x.changeability + " ") +
    ...
    // --------------------- Expressão Not -------------------
    public void numberNotNode(NotNode x) {
        if (x == null) {
            return;
        }
    ...
    public void printNotNode(NotNode x) {
        if (x == null) {
            return;
        }

        System.out.println();
        System.out.print(x.number + ": NotNode ===> " + x.position.image + " " + x.expr.number);
        printExpreNode(x.expr);
    }
